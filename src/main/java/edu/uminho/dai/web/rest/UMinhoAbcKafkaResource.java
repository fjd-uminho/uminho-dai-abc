...
@RestController
@RequestMapping("/api/u-minho-abc-kafka")
public class UMinhoAbcKafkaResource {

    private final Logger log = LoggerFactory.getLogger(UMinhoAbcKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public UMinhoAbcKafkaResource(KafkaProperties kafkaProperties) {
